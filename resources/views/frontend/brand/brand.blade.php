        ...
        @foreach($all_brand_member as $each_brand_member)
          <div class="product">
            	<div class="head_section">
               	  <h2>{!! $each_brand_member->fname.' '.$each_brand_member->lname; !!}</h2>
                  </div>
                <div class="image_section" <?php if(($each_brand_member->pro_image!="")  && (file_exists('uploads/brandmember/'.$each_brand_member->pro_image))){ ?>
                  ...
                  <div class="image_info">
                    <a href="{!! url() !!}/brand-details/{!! $each_brand_member->slug !!}" class="butt butt-green"><img src="<?php echo url();?>/public/frontend/images/icon3.png" alt=""/> View Details</a>
                  </div>
              </div> 
          </div>          
        @endforeach
